...
- [Map](https://map.tranquil.systems) - Native macOS app to build wardley maps using its own `wmap` syntax. GPLv3. It includes a QuickLook plugin to preview `wmap` files as images.
