...
- [VSCode-Wardley-Maps](https://github.com/damonsk/vscode-wardley-maps) - Open source Visual Studio Code extension with the ability to render and edit Wardley Maps directly in VSCode. Based on and compatible with OnlineWardleyMaps. Visual Studio Code Marketplace Install available [here](https://marketplace.visualstudio.com/items?itemName=damonsk.vscode-wardley-maps).
